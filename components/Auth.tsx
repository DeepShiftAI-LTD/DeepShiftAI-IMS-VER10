...
export const Auth: React.FC<AuthProps> = ({ onLogin, onRegister, onResetPassword, getUserByEmail, loginError, setLoginError }) => {
  ...
  const [regForm, setRegForm] = useState({
      ...
      hobbies: '',
      // New Fields
      instituteSupervisorName: '',
      instituteSupervisorPhone: '',
      nextOfKinName: '',
                ...
                <div className="flex-1 p-8 bg-white">
                    ...
                    {mode === 'REGISTER' && (
                        <form onSubmit={handleRegisterSubmit} className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wide border-b border-slate-100 pb-1 mb-3 mt-4">Academic & Skills</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-slate-700 mb-1">University Supervisor Name</label>
                                    <input 
                                        type="text" 
                                        value={regForm.instituteSupervisorName}
                                        onChange={(e) => setRegForm({...regForm, instituteSupervisorName: e.target.value})}
                                        className="w-full p-2 border border-slate-300 rounded-lg outline-none focus:border-indigo-500 text-sm"
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-slate-700 mb-1">Supervisor Telephone</label>
                                    <input 
                                        type="tel" 
                                        value={regForm.instituteSupervisorPhone}
                                        onChange={(e) => setRegForm({...regForm, instituteSupervisorPhone: e.target.value})}
                                        className="w-full p-2 border border-slate-300 rounded-lg outline-none focus:border-indigo-500 text-sm"
                            ...
                            <h3 className="text-sm font-bold text-slate-500 uppercase tracking-wide border-b border-slate-100 pb-1 mb-3 mt-4">Next of Kin (Emergency Contact)</h3>
                            <div>
                                <label className="block text-xs font-bold text-slate-700 mb-1">Next of Kin Name</label>
                                <input 
                                    type="text" 
                                    value={regForm.nextOfKinName}
                                    onChange={(e) => setRegForm({...regForm, nextOfKinName: e.target.value})}
                                    className="w-full p-2 border border-slate-300 rounded-lg outline-none focus:border-indigo-500 text-sm"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        type="text" 
                                        value={regForm.nextOfKinRelationship}
                                        onChange={(e) => setRegForm({...regForm, nextOfKinRelationship: e.target.value})}
                                        className="w-full p-2 border border-slate-300 rounded-lg outline-none focus:border-indigo-500 text-sm"
                                ...
                                <div>
                                    ...
                                    <input 
                                        type="tel" 
                                        value={regForm.nextOfKinPhone}
                                        onChange={(e) => setRegForm({...regForm, nextOfKinPhone: e.target.value})}
                                        className="w-full p-2 border border-slate-300 rounded-lg outline-none focus:border-indigo-500 text-sm"
